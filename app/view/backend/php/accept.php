...
use app\libs\form\MemberAcceptForm;
use app\settings\AuthRightEnum;
use app\settings\ProjectSettings;

class accept extends BackendView
{
    ...
    protected function prepareHtmlDocument(HtmlDocument $htmlDocument): void
    {
        ...
        $memberAcceptForm = new MemberAcceptForm(dbAuthUser: $dbMember->dbAuthUser);
        if ($memberAcceptForm->process()) {
        ...
        $replacements->addEncodedText(
            identifier: 'form',
            content: $memberAcceptForm->render()
        );
    }

    public static function getPath(int $ID): string
    {
        return ProjectSettings::BACKEND_DIRECTORY . 'accept-' . $ID . '.html';
    }
}