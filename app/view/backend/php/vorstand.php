...
class vorstand extends BackendView
{
    ...
    public static function getNavigationItem(): NavigationItem
    {
        return new NavigationItem(
            navKey: 'board',
            href: vorstand::getPath() . '?reset',
            svgPath: '',
            title: 'Vorstand',
            requiredAccessRights: vorstand::getRequiredAccessRights()
        );
    }

    public static function getPath(?int $year = null): string
    {
        return ProjectSettings::BACKEND_DIRECTORY . 'vorstand' . ($year === null ? '' : '-' . $year) . '.html';
    }
