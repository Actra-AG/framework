...
use app\libs\db\DbClub;
use app\libs\db\DbClubRepository;
use app\view\backend\php\clubs;

class ClubModForm extends Form
{
    private readonly TextField $nameField;

    public function __construct(private readonly DbClub $dbClub)
    {
        parent::__construct(name: 'ClubModForm-' . $dbClub->ID);
