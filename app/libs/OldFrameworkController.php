...
{
    public static function prepareHttpResponse(EnvironmentSettingsModel $environmentSettingsModel): HttpResponse
    {
        ExceptionHandler::register(individualExceptionHandler: null);
