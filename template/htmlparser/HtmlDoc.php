...
class HtmlDoc
{
    ...
    {
        $parentSearchNode = $nodeSearch->parentNode;
        $nodeList = ($parentSearchNode === null) ? $this->nodeTree : $nodeSearch->parentNode->childNodes;
        ...
        if ($parentSearchNode === null) {
            ...
            $parentSearchNode->childNodes = $nodeList;
        }
    }
