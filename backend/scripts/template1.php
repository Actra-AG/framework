...
if($copyright < date("Y")) { $copyright .= ' - '.date("Y"); }
...
if(isset($showPage -> pageArr['grundkonf']['navigator']['use']) && $showPage -> pageArr['grundkonf']['navigator']['use']) {
  ...
  if(isset($showPage -> pageArr['grundkonf']['navigator']['reset']) && $showPage -> pageArr['grundkonf']['navigator']['reset']) { $navigator -> resetBreadcrumb(); }
