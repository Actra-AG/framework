...
enum AuthResult: int
{
    ...
    {
        return match ($this) {
            AuthResult::ERROR_UNKNOWN_USER_NAME => HtmlText::encoded(
                textContent: 'Die eingegebenen Zugangsdaten sind ungültig.'
            ),
            AuthResult::ERROR_INACTIVE => HtmlText::encoded(textContent: 'Dieser Zugang ist nicht aktiv.'),
            AuthResult::ERROR_OUT_TRIED => HtmlText::encoded(
                textContent: 'Bei diesem Konto wurde zu oft das falsche Passwort eingegeben.'
            ),
            AuthResult::ERROR_WRONG_PASSWORD => HtmlText::encoded(
                textContent: 'Es wurden ungültige Zugangsdaten eingegeben.'
            ),
            AuthResult::ERROR_NO_PASSWORD_LOGIN_ACTIVE => HtmlText::encoded(
                textContent: 'Die Anmeldung mit Passwort ist für diesen Benutzer nicht aktiviert.'
            ),
            AuthResult::FAILED_SSO_LOGIN => HtmlText::encoded(
                textContent: 'Das Single Sign-On ist leider fehlgeschlagen.'
            ),
